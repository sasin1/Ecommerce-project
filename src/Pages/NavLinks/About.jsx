const About = () => {
  return (
    <>
      <main className=" w -full pt-8 pb-16 lg:pt-16 lg:pb-24 bg-gray-300 dark:bg-gray-900 antialiased">
        <div className="flex justify-between px-4 mx-auto w-full ">
          <article className="mx-auto w-full max-w-2xl format format-sm sm:format-base lg:format-lg format-blue dark:format-invert">
            ...
            <p>
              A typeface is a collection of letters. While each letter is
              unique, certain shapes are shared across letters. A typeface
              represents shared patterns across a collection of letters. A
